...
void Chat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageToSend((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->messageReceived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Chat::*)(const QByteArray & )>(_a, &Chat::messageToSend, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Chat::*)(const QString & , const QString & , const QString & )>(_a, &Chat::messageReceived, 1))
            return;
    }
}
...
// SIGNAL 0
void Chat::messageToSend(const QByteArray & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Chat::messageReceived(const QString & _t1, const QString & _t2, const QString & _t3)
{
