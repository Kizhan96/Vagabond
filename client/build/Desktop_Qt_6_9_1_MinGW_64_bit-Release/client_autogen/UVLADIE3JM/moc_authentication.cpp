...
void Authentication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Authentication::*)(bool )>(_a, &Authentication::loginResult, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Authentication::*)(const QString & )>(_a, &Authentication::loginError, 1))
            return;
    }
}
...
// SIGNAL 0
void Authentication::loginResult(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Authentication::loginError(const QString & _t1)
{
